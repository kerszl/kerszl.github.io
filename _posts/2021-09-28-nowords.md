...
```
You may notice that the date of the **log.txt** file changes every minute. Entering to the directory **/home/me** we find the cause of this confusion. It's a file **doit.py** :smiley:
{: .text-justify}
```console
ncftp /home/me > ls -la
